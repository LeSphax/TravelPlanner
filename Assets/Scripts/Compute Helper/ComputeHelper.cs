...
public static class ComputeHelper
{
  ...
  public const RenderTextureFormat defaultGraphicsFormat = RenderTextureFormat.ARGBFloat;
  ...
  public static void CreateRenderTexture(ref RenderTexture texture, int width, int height, FilterMode filterMode, RenderTextureFormat format, string name = "Unnamed")
  {
